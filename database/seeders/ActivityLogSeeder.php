    ...
    public function run()
{
    DB::table('activity_log')->insert([
        [
            'id' => 696,
            'user_id' => 1,
            'description' => 'Employee "Almendo Gabriel" was Created',
            'activity_date' => Carbon::parse('2023-04-20 15:27:40')
        ],
        [
            'id' => 697,
            'user_id' => 1,
            'description' => 'Employee "Almendo Gabriel" Document was Created',
        ...
        [
            'id' => 700,
            'user_id' => 1,
            'description' => 'Leave for "Almendo Gabriel" was Created',
